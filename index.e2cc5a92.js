var e,t,r,n,i,o,a,s,c,u,l,d,f,p,h,v,g=globalThis;function y(e){return e&&e.__esModule?e.default:e}var m={},b={},_=function(e){return e&&e.Math===Math&&e};// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var j=Function.prototype.call;E=S?j.bind(j):function(){return j.apply(j,arguments)};var O={}.propertyIsEnumerable,L=Object.getOwnPropertyDescriptor;n=L&&!O.call({1:2},1)?function(e){var t=L(this,e);return!!t&&t.enumerable}:O;var $={};$=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var P={},x={},M={},T=Function.prototype,H=T.call,I=S&&T.bind.bind(H,H),q={},N=(M=S?I:function(e){return function(){return H.apply(e,arguments)}})({}.toString),F=M("".slice);q=function(e){return F(N(e),8,-1)};var R=Object,A=M("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
x=k(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
// eslint-disable-next-line no-prototype-builtins -- safe
return!R("z").propertyIsEnumerable(0)})?function(e){return"String"===q(e)?A(e,""):R(e)}:R;var C={},D={};// we can't use just `it == null` since of `document.all` special case
...
G=function(e){var t=U(e,"string");return K(t)?t:t+""};var eN={},eF={},eR=b.document,eA=z(eR)&&z(eR.createElement);eF=function(e){return eA?eR.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
eN=!w&&!k(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
return 7!==Object.defineProperty(eF("div"),"a",{get:function(){return 7}}).a});// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
var eC=Object.getOwnPropertyDescriptor;r=w?eC:function(e,t){if(e=P(e),t=G(t),eN)try{return eC(e,t)}catch(e){}if(eE(e,t))return $(!E(n,e,t),e[t])};var eD={},eW={};// V8 ~ Chrome 36-
...
return t!=t||0===t?0:tw(t)};var tS=Math.max,tj=Math.min;// Helper for a popular repeating case of the spec:
// Let integer be ? ToInteger(index).
// If integer < 0, let result be max((length + integer), 0); else let result be min(integer, length).
tb=function(e,t){var r=t_(e);return r<0?tS(r+t,0):tj(r,t)};var tO={},tL={},t$=Math.min;// `ToLength` abstract operation
// https://tc39.es/ecma262/#sec-tolength
tL=function(e){return e>0?t$(t_(e),9007199254740991):0;// 2 ** 53 - 1 == 9007199254740991
},// `LengthOfArrayLike` abstract operation
// https://tc39.es/ecma262/#sec-lengthofarraylike
tO=function(e){return tL(e.length)};// `Array.prototype.{ indexOf, includes }` methods implementation
var tP=function(e){return function(t,r,n){var i,o=P(t),a=tO(o),s=tb(n,a);// Array#includes uses SameValueZero equality algorithm
...
ty=X("Reflect","ownKeys")||function(e){var t=l(eG(e));return d?tH(t,d(e)):t},tg=function(e,t,n){for(var i=ty(t),o=0;o<i.length;o++){var s=i[o];eE(e,s)||n&&eE(n,s)||a(e,s,r(t,s))}};var tI={},tq=/#|\.prototype\./,tN=function(e,t){var r=tR[tF(e)];return r===tC||r!==tA&&(B(t)?k(t):!!t)},tF=tN.normalize=function(e){return String(e).replace(tq,".").toLowerCase()},tR=tN.data={},tA=tN.NATIVE="N",tC=tN.POLYFILL="P";tI=tN,/*
...
b.postMessage(t8(e),f.protocol+"//"+f.host)};t1&&t2||(t1=function(e){tK(arguments.length,1);var t=B(e)?e:t7(e),r=tV(arguments,1);return t6[++t5]=function(){tW(t,void 0,r)},p(t5),t5},t2=function(e){delete t6[e]},t0?p=function(e){t3.nextTick(rr(e))}:t4&&t4.now?p=function(e){t4.now(rr(e))}:t9&&!tZ?(v=(h=new t9).port2,h.port1.onmessage=rn,p=tB(v.postMessage,v)):b.addEventListener&&B(b.postMessage)&&!b.importScripts&&f&&"file:"!==f.protocol&&!k(ri)?(p=ri,b.addEventListener("message",rn,!1)):p=re in eF("script")?function(e){tQ.appendChild(eF("script"))[re]=function(){tQ.removeChild(this),rt(e)}}:function(e){setTimeout(rr(e),0)});var ro=(tD={set:t1,clear:t2}).clear;// `clearImmediate` method
...
(this.arg=t),v}},e}({});try{regeneratorRuntime=rf}catch(e){// This module should not be running in strict mode, so the above
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=rf:Function("r","regeneratorRuntime = r")(rf)}// to collect all constant we need in this architectuer
const rp="https://forkify-api.herokuapp.com/api/v2/recipes/",rh="016da31e-026e-4491-b383-a111b80211a2",rv=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},rg={recipe:{},search:{query:"",results:[],resultsPerPage:10,page:1},bookmarks:[]},ry=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rm=async function(e){try{let t=await rv(`${rp}${e}?key=${rh}`);rg.recipe=ry(t),rg.bookmarks.some(t=>t.id===e)?rg.recipe.bookmarked=!0:rg.recipe.bookmarked=!1}catch(e){throw console.error("err"),e}},rb=async function(e){try{rg.search.query=e;let t=await rv(`${rp}?search=${e}&key=${rh}`);// console.log(data);
...
}catch(e){throw e}},r_=function(e){rg.search.page=e;let t=(e-1)*rg.search.resultsPerPage,r=e*rg.search.resultsPerPage;//0;
...
rg.bookmarks.push(e),e.id===rg.recipe.id&&(rg.recipe.bookmarked=!0),rk()},rS=function(e){let t=rg.bookmarks.findIndex(t=>t.id===e);rg.bookmarks.splice(t,1),e===rg.recipe.id&&(rg.recipe.bookmarked=!1),rk()};!function(){let e=localStorage.getItem("bookmarks");e&&(rg.bookmarks=JSON.parse(e))}();const rj=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient format! please use the correct formate :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={// id: newRecipe.id,
title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rv(`${rp}?key=${rh}`,r);rg.recipe=ry(n),rE(rg.recipe)}catch(e){throw e}};var rO={};rO=new URL("icons.c14567a0.svg",import.meta.url).toString();class rL{_data;// _errorMessage = 'No recipes found for your query! Please try again!';
/**
...
rendringSpinner=function(){let e=`
      <div class="spinner">
        <svg>
          <use href="${/*@__PURE__*/y(rO)}#icon-loader"></use>
        </svg>
      </div>
    ...
    <div class="error">
      <div>
        <svg>
          <use href="${/*@__PURE__*/y(rO)}#icon-alert-triangle"></use>
        </svg>
      </div>
      <p>${e}</p>
    </div>
    ...
    <div class="message">
      <div>
        <svg>
          <use href="${/*@__PURE__*/y(rO)}#icon-smile"></use>
        </svg>
      </div>
      <p>${e}</p>
    </div>
    `;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",t)}}// import fracty from 'fracty';
class r$ extends rL{_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe. Please try another one!";_message="Start by searching for a recipe or an ingredient. Have fun!";addHandelerRender(e){["hashchange","load"].forEach(t=>window.addEventListener(t,e))}addHandlerUpdateServings(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--update-servings");if(!r)return;let n=+r.dataset.updateTo;n>0&&e(n)}),e()}addHandlerAddBookmark(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--bookmark");r&&e()})}_generateMarkup(){return`
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${/*@__PURE__*/y(rO)}#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${/*@__PURE__*/y(rO)}#icon-users"></use>
            </svg>
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--update-servings"  data-update-to='${this._data.servings-1}'>
                <svg>
                  <use href="${/*@__PURE__*/y(rO)}#icon-minus-circle"></use>
                </svg>
              </button>
              <button class="btn--tiny btn--update-servings" data-update-to='${this._data.servings+1}'>
                <svg>
                  <use href="${/*@__PURE__*/y(rO)}#icon-plus-circle"></use>
                </svg>
              </button>
            </div>
          </div>
          ...
          <div class="recipe__user-generated ${this._data.key?"":"hidden"}">
            <svg>
              <use href="${/*@__PURE__*/y(rO)}#icon-user"></use>
            </svg>
          </div>
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use href="${/*@__PURE__*/y(rO)}#icon-bookmark${this._data.bookmarked?"-fill":""}"></use>
            </svg>
          </button>
        </div>
        ...
        <div class="recipe__directions">
          ...
          >
            ...
            <svg class="search__icon">
              <use href="${/*@__PURE__*/y(rO)}#icon-arrow-right"></use>
            </svg>
          </a>
        </div>
    ...
    <li class="recipe__ingredient">
      <svg class="recipe__icon">
        <use href="${/*@__PURE__*/y(rO)}#icon-check"></use>
      </svg>
...
=new r$;class rx{_parentElement=document.querySelector(".search");getQuery(){let e=this._parentElement.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentElement.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rM=new rx,rT=new class extends rL{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
    <li class="preview">
    ...
    `}};class rH extends rL{_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again!";_message;_generateMarkup(){return this._data.map(e=>rT.render(e,!1)).join("")}}var rI=new rH;class rq extends rL{_parentElement=document.querySelector(".pagination");addHandlerClick(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--inline");if(!r)return;let n=+r.dataset.goto;e(n)})}_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(//page 1, and there are other pages
1===e&&t>1?this.showNextResult(e):e===t&&t>1?this.showPrevResult(e):e<t?`
    ...
    <button data-goto="${e-1}" class="btn--inline pagination__btn--prev">
        <svg class="search__icon">
        <use href="${/*@__PURE__*/y(rO)}#icon-arrow-left"></use>
        </svg>
        <span>Page ${e-1}</span>
    </button>
      `}}var rN// <button data-goto="${
=new rq;class rF extends rL{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it :)";_message;addHandlerRender(e){window.addEventListener("load",e())}_generateMarkup(){return this._data.map(e=>rT.render(e,!1)).join("")}}var rR=new rF;// import icons from 'url:../../img/icons.svg';
class rA extends rL{_parentElement=document.querySelector(".upload");_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");_message="Recipe was Successfully Uploaded";constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggle(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggle.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggle.bind(this)),this._overlay.addEventListener("click",this.toggle.bind(this))}_addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();// new FormData(form that we need input value from it)
// this=> this._parentElement =>> becouseOF addEventListener
let r=[...new FormData(this)],n=Object.fromEntries(r);//Array
e(n)})}_generateMarkup(){}}var rC=new rA;// if (module.hot) {
//   module.hot.accept();
// }
///////////////////////////////////////
const rD=async function(){try{let e=window.location.hash.slice(1);if(!e)return rP.renderMessage();rP.rendringSpinner(),rI.update(r_()),rR.update(rg.bookmarks),// 2) Loading recipe
...
await rb(e),rI.render(r_(1)),rN.render(rg.search);// showRes(1);
}catch(e){rI.renderError()}},rG=async function(e){try{await rj(e),rP.render(rg.recipe),rC.renderMessage(),rR.render(rg.bookmarks),//change id in url
window.history.pushState(null,"",`#${rg.recipe.id}`),//close from window
setTimeout(function(){rC.toggle()},2.5)}catch(e){rC.renderError(e.message)}};rR.addHandlerRender(function(){rR.render(rg.bookmarks)}),rP.addHandelerRender(rD),rP.addHandlerUpdateServings(function(e){//update the recipe servings (in state object)
rw(e),rP.render(rg.recipe)}),rP.addHandlerAddBookmark(function(){rg.recipe.bookmarked?rS(rg.recipe.id):rE(rg.recipe),rP.update(rg.recipe),rR.render(rg.bookmarks)}),rM.addHandlerSearch(rW),rN.addHandlerClick(function(e){rI.render(r_(e)),rN.render(rg.search)}),rC._addHandlerUpload(rG);//# sourceMappingURL=index.e2cc5a92.js.map

//# sourceMappingURL=index.e2cc5a92.js.map
