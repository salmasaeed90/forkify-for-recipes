...
const controlRecipes = async function() {
    try {
        ...
        if (!id) return (0, _recipeViewJsDefault.default).renderMessage();
        (0, _recipeViewJsDefault.default).rendringSpinner();
...
const controlSearchResults = async function() {
    try {
        (0, _resultsViewJsDefault.default).rendringSpinner();
        //1)get search query
        const query = (0, _searchViewJsDefault.default).getQuery();
        if (!query) return (0, _resultsViewJsDefault.default).renderMessage();
        //loading spinner
        //2) load search resaults
        await _modelJs.loadSearchResults(query);
        //3) render search results
        (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage(1));
        //initiall pagination buttons
...
// const showRes = function (goToPage) {
//   //1) render new search results
...
const controlAddRecipe = async function(newRecipe) {
    try {
        await _modelJs.uploadeRecipe(newRecipe);
        ...
        //close from window
        setTimeout(function() {
            (0, _addRecipeViewJsDefault.default).toggle();
        }, (0, _config.MODEL_CLOSE_SEC));
    } catch (err) {
        (0, _addRecipeViewJsDefault.default).renderError(err.message);
    }
};
//puplisher subscriber pattern
const init = function() {
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./view/recipeView.js":"7Olh7","./view/searchView.js":"blwqv","./view/resultsView.js":"46Nfk","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view/paginationView.js":"9Reww","./view/bookmarksView.js":"uOrlR","./view/addRecipeView.js":"bxpSm","./config":"k5Hzs"}],"49tUX":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "uploadeRecipe", ()=>uploadeRecipe);
...
const updateServings = function(newServings) {
    ...
    //newqu = oldqu * newserv / oldserv//2*8/4
    });
...
const addBookmark = function(recipe) {
    ...
    if (recipe.id === state.recipe.id) state.recipe.bookmarked = true; // set new property in recipe object => bookmarked
    presistBookmarks();
};
...
init();
const uploadeRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ing)=>{
            const ingArr = ing[1].split(",").map((el)=>el.trim());
            if (ingArr.length !== 3) throw Error(`Wrong ingredient format! please use the correct formate :)`);
        ...
        console.log(data);
        state.recipe = createRecipeObject(data); //to be in the same formate recipe(render with details) object
...
// to collect all constant we need in this architectuer
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const API_KEY = "016da31e-026e-4491-b383-a111b80211a2";
...
// contain methods that will use it over and over in the application
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new RecipeView(); //  ? fracty(el.quantity).toString() : ''
 //href="${icons}#icon-bookmark-fill"
...
class View {
   ...
   */ render(data, render = true) {
    ...
    update(data) {
        ...
        //convert markup to html code and take copy from it.
...
class SearchView {
    ...
    getQuery() {
        const queryValue = this._parentElement.querySelector(".search__field").value;
        this._clearInput();
        return queryValue;
    }
    _clearInput() {
...
},{"./view":"4wVyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"8eAfY"}],"8eAfY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        // const allPages = this._data.results.length;
        const numPages = Math.ceil(this._data.results.length / this._data.resultsPerPage);
        //page 1, and there are other pages
        if (currPage === 1 && numPages > 1) return `
      <div class="pagination">
      ${this.showAllpages(numPages)}
      ${this.showNextResult(currPage)}
      </div>
    `;
        //last page
        if (currPage === numPages && numPages > 1) return `
        <div class="pagination">
        ${this.showPrevResult(currPage)}
        ${this.showAllpages(numPages)}
        </div>
      `;
        //other page
    ...
    showAllpages(numPages, currPage) {
        return `
    <button disabeld class="btn--inline pagination__btn--center">
        <span>from ${numPages}</span>
    </button>
      `;
    }
}
exports.default = new PaginationView(); // <button data-goto="${
 //   currPage - 1
...
},{"./view.js":"4wVyX","./previewView.js":"8eAfY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bxpSm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class AddRecipeView extends (0, _viewDefault.default) {
    ...
    _addHandlerUpload(handler) {
        this._parentElement.addEventListener("submit", function(e) {
            e.preventDefault();
            // new FormData(form that we need input value from it)
            // this=> this._parentElement =>> becouseOF addEventListener
            const dataArr = [
                ...new FormData(this)
            ]; //Array
            //convert Array to Object => to add it as a recipe
...
},{"./view":"4wVyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire3a11")
